...
public class CollapseRecordResource {
    ...
    public GetVo<CollapseRecord> collapseRecordAll(HttpServletRequest request) {
    ...
    public GetVo<CollapseRecord> collapseRecordByTime(@PathVariable("time") int time, HttpServletRequest request) {
        int limit = Integer.parseInt(request.getParameter("limit"));
        int page = Integer.parseInt(request.getParameter("page"));
    ...
    public GetVo<SecondaryDisasterStatistics> getLastCollapseRecordStatistics() {
    ...
    public PostVo<CollapseRecord> editCollapseRecord(HttpServletRequest request, @PathVariable("id") String id) {
    ...
    public PostVo<CollapseRecord> delCollapseRecord(@PathVariable("id") String id) {
