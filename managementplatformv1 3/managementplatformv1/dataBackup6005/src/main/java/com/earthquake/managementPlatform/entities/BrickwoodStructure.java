...
public class BrickwoodStructure {
    ...
    public BrickwoodStructure(String id, String date, String location, Double basicallyIntactSquare, Double damagedSquare, Double destroyedSquare, String note, String reportingUnit, String earthquakeId) {
        this.id = id;
        this.date = date;
