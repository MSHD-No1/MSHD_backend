...
public class CodeResource {
    ...
    public GetVo getCityAid(@PathVariable("provinceId") String provinceId) {
        ...
        getVo.setData(administrativeRegionCode12Mapper.getCityAid(provinceId));
        getVo.setCount(administrativeRegionCode12Mapper.getCityAid(provinceId).size());
        return getVo;
    }
    ...
    public GetVo getCountryAid(@PathVariable("cityId") String cityId) {
        ...
        getVo.setData(administrativeRegionCode12Mapper.getCountryAid(cityId));
        getVo.setCount(administrativeRegionCode12Mapper.getCountryAid(cityId).size());
        return getVo;
    }
    ...
    public GetVo getTownAid(@PathVariable("countryId") String countryId) {
        ...
        getVo.setData(administrativeRegionCode12Mapper.getTownAid(countryId));
        getVo.setCount(administrativeRegionCode12Mapper.getTownAid(countryId).size());
        return getVo;
    }
    ...
    public GetVo getVillageAid(@PathVariable("townId") String townId) {
        ...
        getVo.setData(administrativeRegionCode12Mapper.getVillageAid(townId));
        getVo.setCount(administrativeRegionCode12Mapper.getVillageAid(townId).size());
        return getVo;
    }
}
